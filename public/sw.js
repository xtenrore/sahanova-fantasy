const CACHE='sahanova-v3';
const ASSETS=['/','/index.html','/styles.css','/enhancements.css','/js/app.js','/js/data.js','/js/domain.js','/js/state.js','/js/i18n.js','/js/icons.js','/js/insights.js','/js/enhancements.js','/admin/','/admin/index.html','/js/admin.js','/assets/logo-mark.svg','/assets/icon-192.png','/assets/icon-512.png','/offline.html'];
