...
const required=[
 'public/index.html','public/styles.css','public/enhancements.css','public/js/app.js','public/js/domain.js','public/js/data.js','public/js/insights.js','public/js/enhancements.js','public/js/admin.js',
...
for(const f of ['public/js/app.js','public/js/data.js','public/js/domain.js','public/js/state.js','public/js/i18n.js','public/js/icons.js','public/js/insights.js','public/js/enhancements.js','public/js/admin.js','server.mjs','src/node-session.js']){
 const r=spawnSync(process.execPath,['--check',f],{encoding:'utf8'});if(r.status!==0){console.error(r.stderr);process.exit(r.status||1)}
}
console.log(`Build check OK — ${required.length} required artifacts, Nova IQ module, and Railway Node server JavaScript syntax validated.`);
